...
namespace OnLooker
{
    public partial class App : Application
    {
        ...
        public Dictionary<string, string> ExprTxtImgMap = new Dictionary<string, string>();        
        ...
        public App()
        {
            ...
            {
                ExprTxtImgMap.Add("[高兴]", "Images/Expr/happy.png");
                ExprTxtImgMap.Add("[悲伤]", "Images/Expr/sad.png");
                // 显示当前帧速率计数器。
        ...
        {
            AMapConfig.Key = "b5ae66a65ae4a1ee99661d137ab1c270";
        }
