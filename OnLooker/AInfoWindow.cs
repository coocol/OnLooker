...
namespace AMapInfoWindow
{
    ...
    public sealed class AInfoWindow : UserControl
    {
        ...
        public AInfoWindow()
        {
            ...
            TitleBackgroundColor = Color.FromArgb(210, 120, 0, 0);//HexToColor("#FF2D2D2D");
            ContentBackgroundColor = Color.FromArgb(210, 0, 120, 0);//HexToColor("#2F3236");
            SetBackgroundColor();
        ...
        protected override void OnManipulationStarted(System.Windows.Input.ManipulationStartedEventArgs e)
        {
            ...
            (Application.Current.RootVisual as PhoneApplicationFrame).Navigate(new Uri("/EventDetailsPage.xaml", UriKind.RelativeOrAbsolute));
        ...
        {
            path.Fill = new SolidColorBrush(TitleBackgroundColor);
